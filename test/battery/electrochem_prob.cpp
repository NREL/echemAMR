#include <../../amrex/Src/Amr/AMReX_PROB_AMR_F.H> //FIXME: cant seem to locate this file
...
//        pp.queryarr("pot_bc_lo", echemAMR::h_prob_parm->pot_bc_lo, 0, AMREX_SPACEDIM );
//        pp.queryarr("pot_bc_hi", echemAMR::h_prob_parm->pot_bc_hi, 0, AMREX_SPACEDIM );

        amrex::Abort("wow you found out how to call this!");
        // FIXME for some reason this is not called
        // not sure how this works since this came from the GPU/CNS tutorial
